...
class Model(ModelDesc, Config):
    ...
    def inputs(self):
        ...
        return [tf.TensorSpec(tf.float32, [None, self.train_input_shape[0],self.train_input_shape[1], 3], 'images'),
                tf.TensorSpec(tf.float32, [None, self.train_mask_shape[0],self.train_mask_shape[1],None], 'truemap-coded')]
